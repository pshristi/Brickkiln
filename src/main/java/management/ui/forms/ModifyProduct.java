...
public class ModifyProduct {
		    ...
		    public void setcomponents()
		    {
		        ...
		        l1=new JLabel("Change Product Rate");
		    	...
		    	b1.addActionListener(new ActionListener() {
		    		public void actionPerformed(ActionEvent e)
		    		{
		    			...
		    			if(i>0){
		    				JOptionPane.showMessageDialog(null,"Product rate changed successfully!" );
					...
					private int save(String product,int rate) {
						...
						PreparedStatement p1=con.prepareStatement("update finalproduction set rate=? where product=?");
						p1.setString(2, product);
						p1.setInt(1, rate);
			...
			public static void main(String[] args) {
				ModifyProduct ol=new ModifyProduct();
